 ...
 *
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloworld.org.rsi/", wsdlLocation = "http://localhost:8080/web-service-1.0-SNAPSHOT/HelloWorldImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://helloworld.org.rsi/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/web-service-1.0-SNAPSHOT/HelloWorldImplService?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://helloworld.org.rsi/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld.org.rsi/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
